                ...
                <div class="span12">
                        ...
                        <div>
                                ...
                                <div id="save_Node" style="display:none">
                                        ...
                                        <%=ResourceLoader.GetResource(session, "items.inquiry")%> <input type="text" id="NODEsetInquiryUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/inquiry" value="http://localhost:9090/juddiv3/services/inquiry"><br>
                                        <%=ResourceLoader.GetResource(session, "items.publish")%> <input type="text" id="NODEsetPublishUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/publish" value="http://localhost:9090/juddiv3/services/publish"><br>
                                        <%=ResourceLoader.GetResource(session, "items.security")%> <input type="text" id="NODEsetSecurityUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/security" value="http://localhost:9090/juddiv3/services/security"><br>
                                        <%=ResourceLoader.GetResource(session, "items.subscription.list")%> <input type="text" id="NODEsetSubscriptionListenerUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/subscription-listener" value="http://localhost:9090/juddiv3/services/subscription-listener"><br>
                                        <%=ResourceLoader.GetResource(session, "items.subscription")%> <input type="text" id="NODEsetSubscriptionUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/subscription" value="http://localhost:9090/juddiv3/services/subscription"><br>
                                        <%=ResourceLoader.GetResource(session, "items.custodytransfer")%> <input type="text" id="NODEsetCustodyTransferUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/custody-transfer" value="http://localhost:9090/juddiv3/services/custody-transfer"><br>
                                        <%=ResourceLoader.GetResource(session, "items.replication")%> <input type="text" id="NODEsetReplicationUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/replication" value="http://localhost:9090/juddiv3/services/replication"><br>
                                        jUDDI API <input type="text" id="NODEsetJuddiApiUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/juddi-api" value="http://localhost:9090/juddiv3/services/juddi-api"><br>
                                </div>
                                <div id="save_Clerk" style="display:none">
                                        ...
                                        <%=ResourceLoader.GetResource(session, "items.inquiry")%> <input type="text" id="CLERKNODEsetInquiryUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/inquiry" value="http://localhost:9090/juddiv3/services/inquiry"><br>
                                        <%=ResourceLoader.GetResource(session, "items.publish")%> <input type="text" id="CLERKNODEsetPublishUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/publish" value="http://localhost:9090/juddiv3/services/publish"><br>
                                        <%=ResourceLoader.GetResource(session, "items.security")%> <input type="text" id="CLERKNODEsetSecurityUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/security" value="http://localhost:9090/juddiv3/services/security"><br>
                                        <%=ResourceLoader.GetResource(session, "items.subscription.list")%> <input type="text" id="CLERKNODEsetSubscriptionListenerUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/subscription-listener" value="http://localhost:9090/juddiv3/services/subscription-listener"><br>
                                        <%=ResourceLoader.GetResource(session, "items.subscription")%> <input type="text" id="CLERKNODEsetSubscriptionUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/subscription" value="http://localhost:9090/juddiv3/services/subscription"><br>
                                        <%=ResourceLoader.GetResource(session, "items.custodytransfer")%> <input type="text" id="CLERKNODEsetCustodyTransferUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/custody-transfer" value="http://localhost:9090/juddiv3/services/custody-transfer"><br>
                                        <%=ResourceLoader.GetResource(session, "items.replication")%> <input type="text" id="CLERKNODEsetReplicationUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/replication" value="http://localhost:9090/juddiv3/services/replication"><br>
                                        jUDDI API <input type="text" id="CLERKNODEsetJuddiApiUrl"  class="forminput" placeholder="http://localhost:9090/juddiv3/services/juddi-api" value="http://localhost:9090/juddiv3/services/juddi-api"><br>
